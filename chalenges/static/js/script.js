...
//chalenge change color of all buttons
...
function buttonColorChange(buttonattr){
    if (buttonattr.value ==='red'){
        buttonRed();
    }
    else if(buttonattr.value ==='green'){
        buttonGreen();
   
    }
    else if (buttonattr.value ==='reset'){
        buttonReset();
